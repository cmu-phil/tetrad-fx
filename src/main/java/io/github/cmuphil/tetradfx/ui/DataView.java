...
public class DataView {
    ...
    static ContextMenu getContextMenu(TableView<DataRow> pane, DataSet dataSet) {
        ...
        removeConstantColumns.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Remove Constant Columns", filtered, true, true);
        });
        ...
        center.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Center", filtered, true, true);
        });
        ...
        standardize.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Standardize", filtered, true, true);
        });
        ...
        nonparanormalTransform.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Nonparanormal Transform", filtered, true, true);
        });
        ...
        logTransform.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Log Transform", filtered, true, true);
        });
        ...
        numericalDiscreteToContinuous.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Numerical Discrete to Continuous", filtered, true, true);
        });
        ...
        discretizeToBinary.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Discretize to Binary", filtered, true, true);
        });
        ...
        discretize.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Discretize to Trinary", filtered, true, true);
        });
        ...
        restrictToMeasured.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Restrict to Measured", filtered, true, true);
        });
        ...
        shuffleColumns.setOnAction(e -> {
            ...
            NamesToContents.getInstance().getSelectedContents().addDataSet("Shuffle Columns", filtered, true, true);
        });
