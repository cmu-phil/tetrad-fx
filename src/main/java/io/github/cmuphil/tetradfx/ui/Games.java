...
public class Games {
    public static void baseGamesOnDataset() {
        ...
        addGame("This the PC Search Game. We are assuming here that the underlying model is a DAG and that there are no latent variables. If you don't think this is true of your data, maybe you shouldn't play this game!\n" +
                ...
                "\n" +
                "We will tell you the number of edges in your graph at each step. If a true graph is available, the goal is to get to SHD = 0! Otherwise you're on your own Can you do it in the fewest number of steps? Good luck!", "PC Search Game");

        addGame("This is the Permutation Search Game! We are assuming that the underlying model is a DAG and that there are no latent variables. Is this a good assumption for your data?\n" +
                "\n" +
                ...
                "\n" +
                "Maybe you will come up with a new permutation algorithm!", "Permutation Search Game");
    }
    ...
    static void baseGamesOnGraph() {
        ...
        addGame("This the D-separation Game. We will give you potential d-separation facts, and you need to say whether the d-separation facts hold in the graph you've selectd!\n" +
                        ...
                        "\n" +
                "Can you get all of them right? Good luck! Don't forget to check descendants of colliders!", "D-separation Game");

        addGame("This the PC Search Game. We are assuming here that the graph is a DAG and that there are no latent variables. If you don't think this is true, maybe you shouldn't play this game!\n" +
                        "                            \n" +
                        ...
                        "\n" +
                "We will tell you the SHD score of your graph at each step. The goal is to get to SHD = 0! Can you do it in the fewest number of steps? Good luck!", "PC Search Game");

        addGame("This is the Permutation Search Game! We are assuming that the correct model is a DAG and that there are no latent variables. Is this a good assumption for your graph?\n" +
                        "\n" +
                        "Each permutation of the graph implies a DAG. We will give you a random permutation, and you need to rearrange the nodes so that the implied DAG is correct! \n" +
                        "\n" +
